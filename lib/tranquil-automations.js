...
export default {
  ...
  activate(state) {
    ...
    if (atom.config.get("tranquil-automations.showBusinessMockups")) {
      ...
      // Trusted mockups self-register their controls over RPC (see ../mockups/*.html); untrusted
      // browser pages get a host-defined default control. Register before pages connect.
